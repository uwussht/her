...
mixin _$ContentItem {
 ...
 String get id; ContentType get type; ContentCategory get category;@LocalizedTextConverter() LocalizedText get title;@LocalizedTextConverter() LocalizedText get summary; AccessTier get tier;/// Reading or watching time, in minutes.
...
int get hashCode {
  final _this = this as ContentItem;
  return Object.hash(runtimeType,_this.id,_this.type,_this.category,_this.title,_this.summary,_this.tier,_this.durationMinutes,const DeepCollectionEquality().hash(_this.stages),const DeepCollectionEquality().hash(_this.interests),_this.pregnancyWeek,_this.courseId,_this.expertId,_this.imageUrl,_this.videoUrl,_this.viewCount,_this.publishedAt);
}

@override
String toString() {
  final _this = this as ContentItem;
  return 'ContentItem(id: ${_this.id}, type: ${_this.type}, category: ${_this.category}, title: ${_this.title}, summary: ${_this.summary}, tier: ${_this.tier}, durationMinutes: ${_this.durationMinutes}, stages: ${_this.stages}, interests: ${_this.interests}, pregnancyWeek: ${_this.pregnancyWeek}, courseId: ${_this.courseId}, expertId: ${_this.expertId}, imageUrl: ${_this.imageUrl}, videoUrl: ${_this.videoUrl}, viewCount: ${_this.viewCount}, publishedAt: ${_this.publishedAt})';
}
...
@useResult
$Res call({
 String id, ContentType type, ContentCategory category,@LocalizedTextConverter() LocalizedText title,@LocalizedTextConverter() LocalizedText summary, AccessTier tier, int durationMinutes, List<LifeStage> stages, List<Interest> interests, int? pregnancyWeek, String? courseId, String? expertId, String? imageUrl, String? videoUrl, int viewCount, DateTime? publishedAt
});
...
/// Create a copy of ContentItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? category = null,Object? title = null,Object? summary = null,Object? tier = null,Object? durationMinutes = null,Object? stages = null,Object? interests = null,Object? pregnancyWeek = freezed,Object? courseId = freezed,Object? expertId = freezed,Object? imageUrl = freezed,Object? videoUrl = freezed,Object? viewCount = null,Object? publishedAt = freezed,}) {
...
as LocalizedText,tier: null == tier ? _self.tier : tier // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  ContentType type,  ContentCategory category, @LocalizedTextConverter()  LocalizedText title, @LocalizedTextConverter()  LocalizedText summary,  AccessTier tier,  int durationMinutes,  List<LifeStage> stages,  List<Interest> interests,  int? pregnancyWeek,  String? courseId,  String? expertId,  String? imageUrl,  String? videoUrl,  int viewCount,  DateTime? publishedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContentItem() when $default != null:
return $default(_that.id,_that.type,_that.category,_that.title,_that.summary,_that.tier,_that.durationMinutes,_that.stages,_that.interests,_that.pregnancyWeek,_that.courseId,_that.expertId,_that.imageUrl,_that.videoUrl,_that.viewCount,_that.publishedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  ContentType type,  ContentCategory category, @LocalizedTextConverter()  LocalizedText title, @LocalizedTextConverter()  LocalizedText summary,  AccessTier tier,  int durationMinutes,  List<LifeStage> stages,  List<Interest> interests,  int? pregnancyWeek,  String? courseId,  String? expertId,  String? imageUrl,  String? videoUrl,  int viewCount,  DateTime? publishedAt)  $default,) {final _that = this;
switch (_that) {
case _ContentItem():
return $default(_that.id,_that.type,_that.category,_that.title,_that.summary,_that.tier,_that.durationMinutes,_that.stages,_that.interests,_that.pregnancyWeek,_that.courseId,_that.expertId,_that.imageUrl,_that.videoUrl,_that.viewCount,_that.publishedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  ContentType type,  ContentCategory category, @LocalizedTextConverter()  LocalizedText title, @LocalizedTextConverter()  LocalizedText summary,  AccessTier tier,  int durationMinutes,  List<LifeStage> stages,  List<Interest> interests,  int? pregnancyWeek,  String? courseId,  String? expertId,  String? imageUrl,  String? videoUrl,  int viewCount,  DateTime? publishedAt)?  $default,) {final _that = this;
switch (_that) {
case _ContentItem() when $default != null:
return $default(_that.id,_that.type,_that.category,_that.title,_that.summary,_that.tier,_that.durationMinutes,_that.stages,_that.interests,_that.pregnancyWeek,_that.courseId,_that.expertId,_that.imageUrl,_that.videoUrl,_that.viewCount,_that.publishedAt);case _:
  return null;
...
class _ContentItem extends ContentItem {
  const _ContentItem({required this.id, required this.type, required this.category, @LocalizedTextConverter() required this.title, @LocalizedTextConverter() required this.summary, this.tier = AccessTier.free, required this.durationMinutes,  List<LifeStage> stages = const <LifeStage>[],  List<Interest> interests = const <Interest>[], this.pregnancyWeek, this.courseId, this.expertId, this.imageUrl, this.videoUrl, this.viewCount = 0, this.publishedAt}): _stages = stages,_interests = interests,super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,type,category,title,summary,tier,durationMinutes,const DeepCollectionEquality().hash(_stages),const DeepCollectionEquality().hash(_interests),pregnancyWeek,courseId,expertId,imageUrl,videoUrl,viewCount,publishedAt);
}

@override
String toString() {
    return 'ContentItem(id: $id, type: $type, category: $category, title: $title, summary: $summary, tier: $tier, durationMinutes: $durationMinutes, stages: $stages, interests: $interests, pregnancyWeek: $pregnancyWeek, courseId: $courseId, expertId: $expertId, imageUrl: $imageUrl, videoUrl: $videoUrl, viewCount: $viewCount, publishedAt: $publishedAt)';
}
...
/// Create a copy of ContentItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = null,Object? category = null,Object? title = null,Object? summary = null,Object? tier = null,Object? durationMinutes = null,Object? stages = null,Object? interests = null,Object? pregnancyWeek = freezed,Object? courseId = freezed,Object? expertId = freezed,Object? imageUrl = freezed,Object? videoUrl = freezed,Object? viewCount = null,Object? publishedAt = freezed,}) {
